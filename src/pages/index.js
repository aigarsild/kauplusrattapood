...
<Layout>
    ...
    <SEO title="Ratta hooldus ja parandus" description="Kauplus rattapood parandab ja hooldab rattaid, ratta hoolduse hinnakiri" />
                <section className="row slider d-flex align-content-center flex-wrap min-vh-100">
                    ...
                    <div className="w-100 text-center">
                        <a href="#hinnakiri" className="shadow btn btn-dark font-weight-bold m-4 pt-3 pb-3 pl-5 pr-5">Vaata rattahooldus hinnakirja</a>
                    </div>
                </section>
